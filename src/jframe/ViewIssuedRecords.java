 ...
 * @author ahmad
 */
public class ViewIssuedRecords extends javax.swing.JFrame {
 ...
 DefaultTableModel model;
   ...
   model.addRow(obj);
    ...
    private void initComponents() {
        ...
        jLabel12.setText(" View Issued Records");
        jPanel5.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 110, 430, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewIssuedRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
           new ViewIssuedRecords().setVisible(true);
            }
        });
    }
